...
#define GPIOA_LCD5110_CS            11U
#define GPIOA_ARD_D2                12U
#define GPIOA_LCD5110_DC            12U
...
#define LINE_LCD5110_SCK            PAL_LINE(GPIOA, 1U)
...
#define LINE_LCD5110_CS             PAL_LINE(GPIOA, 11U)
#define LINE_ARD_D2                 PAL_LINE(GPIOA, 12U)
#define LINE_LCD5110_DC             PAL_LINE(GPIOA, 12U)
 ...
 *
 * PA0  - ARD_A0                    (analog).
 * PA1  - ARD_A1 LCD5110_SCK        (alternate 5).
 ...
 * PA9  - ARD_D1                    (analog).
 * PA10 - ARD_D0                    (analog).
 * PA11 - ARD_D10 LCD5110_CS        (output pushpull maximum).
 * PA12 - ARD_D2 LCD5110_DC         (output pushpull maximum).
 ...
 * PB4  - ARD_D12 LCD5110_MISO      (alternate 5).
 * PB5  - ARD_D11 LCD5110_MOSI      (alternate 5).
 * PB6  - ARD_D5 ARD_A5_ALT LCD5110_LIGHT(output pushpull maximum).
 * PB7  - ARD_D4 ARD_A4_ALT LCD5110_RST(output pushpull maximum).
 * PB8  - PIN8                      (analog).
 * PB9  - PIN9                      (analog).
 * PB10 - PIN10                     (analog).
 * PB11 - PIN11                     (analog).
